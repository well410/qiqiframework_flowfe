                    ...
                    <div class="tools-bar" style="margin-bottom: 8px;width: 180px;">
                        ...
                        <div class="tools-button">
                            <el-upload
                                ...
                                <el-button type="primary" size="mini" icon="el-icon-plus" @click="decsAddBefore">新增
                                </el-button>
                            </el-upload>
                        </div>
                    </div>
                        ...
                        <el-card :body-style="{ padding: '0px' }">
                            <div slot="header" class="clearfix">
                                    <div class="header-title">
                                        ...
                                        <div class="clearfix" style="width: 100%">
                                            <template v-if="isNotEmpty(o.releaseType) && o.releaseType === 'N'">
                                                <el-tag type="success" effect="light" style="width:20%">测</el-tag>
                                            </template>
                                            <template v-if="isNotEmpty(o.releaseType) && o.releaseType === 'S'">
...
<!--                                </div>-->
                            ...
                            <div class="bottom ">
                                <div>
                                    <el-button class="icon-button" icon="el-icon-edit" size="mini"
                                               @click="decsEditBefore(o)"
                                               title="编辑"></el-button>
                                    <el-dropdown trigger="click" @command="decsFlowClickS($event, o)" placement = "top">
                                        <el-button class="icon-button" icon="el-icon-setting" size="mini"
                                                   @click="decsFlowClickN(o)"
                                                   title="决策图"></el-button>
                                        <el-dropdown-menu slot="dropdown">
                                            <template v-if="o.releaseType === 'S'">
                                                <template v-if="o.inteConf.showA === true">
                                                    <el-dropdown-item command="A" :title=o.inteConf.urlA>路由A</el-dropdown-item>
                                                </template>
                                                <template v-if="o.inteConf.showB === true">
                                                    <el-dropdown-item command="B" :title=o.inteConf.urlB>路由B</el-dropdown-item>
                                                </template>
                                            </template>
                                        </el-dropdown-menu>
                                    </el-dropdown>
                                    <el-dropdown trigger="click" @command="decsPreHandleClickS($event, o)" placement = "top">
                                        <el-button class="icon-button" icon="el-icon-video-play" size="mini"
                                                   @click="decsPreHandleClickN(o)"
                                    ...
                                    <el-dropdown trigger="click" @command="decsVersionClickS($event, o)" placement = "top">
                                        <el-button class="icon-button" icon="el-icon-files" size="mini"
                                                   @click="decsVersionClickN(o)"
                                                   title="版本"></el-button>
                                        <el-dropdown-menu slot="dropdown">
                                            <template v-if="o.releaseType === 'S'">
                                                <template v-if="o.inteConf.showA === true">
                                    ...
                                    <el-dropdown trigger="click" @command="decsHisClickS($event, o)" placement = "top">
                                        <el-button class="icon-button" icon="el-icon-document" size="mini"
                                                   @click="decsHisClickN(o)"
                                                   title="历史"></el-button>
                                        <el-dropdown-menu slot="dropdown">
                                            <template v-if="o.releaseType === 'S'">
                                                <template v-if="o.inteConf.showA === true">
        ...
        <el-dialog
            ...
            <el-form ref="addFrom" :model="add.decs" :rules="addRules" label-width="100px" size="mini"
                ...
                <el-row>
                    <el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12">
                        <el-form-item label="配置版本:" prop="releaseType" >
                            <el-select v-model="add.decs.releaseType" clearable @change="onSelectedReleaseTypeAdd(add.decs.releaseType)" style="width: 100%">
                                <el-option label="测试版本" value="N"></el-option>
                                <el-option label="运行版本" value="S"></el-option>
                            </el-select>
                        </el-form-item>
                    </el-col>
                    <el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12">
                ...
                <template v-if="add.decs.releaseType === 'N'">
                    <el-row>
                        <el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12">
                ...
                <template v-if="add.decs.releaseType === 'S'">
                    <el-row>
                        <el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12">
                            <el-form-item label="接入类型:" prop="inteType">
                                <el-select v-model="add.decs.inteType" clearable
                                           @change="onSelectedInteTypeAdd(add.decs.releaseType, add.decs.inteType)"
                                           style="width: 100%">
                                    <el-option label="http" value="H"></el-option>
                                    <el-option label="kafka" value="K"></el-option>
                                    <el-option label="jar包引用" value="J"></el-option>
                                </el-select>
                            </el-form-item>
                        </el-col>
                    </el-row>
...
<!--                    </el-form-item>-->
            ...
            <template slot="footer">
                ...
                <el-button v-else-if="isNeedTemplate==='Y'" type="primary" size="mini" icon="el-icon-plus"
                           @click="decsAddByTemplateAfter">确定
                </el-button>
        ...
        <el-dialog
            ...
            <el-form ref="editFrom" :model="edit.decs" :rules="editRules" label-width="100px" size="mini"
                ...
                <el-row>
                    <el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12">
                        <el-form-item label="配置版本:" prop="releaseType">
                            <el-select v-model="edit.decs.releaseType" clearable @change="onSelectedReleaseTypeEdit(edit.decs.releaseType)" style="width: 100%" >
                                <el-option label="测试版本" value="N"></el-option>
                                <el-option label="运行版本" value="S"></el-option>
                            </el-select>
                        </el-form-item>
                ...
                <template v-if="edit.decs.releaseType === 'N'">
                    <el-row>
                        <el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12">
                            <el-form-item label="接入类型:" prop="inteType">
                ...
                <template v-if="edit.decs.releaseType === 'S'">
                    <el-row>
                        <el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12">
                            <el-form-item label="接入类型:" prop="inteType">
                                <el-select v-model="edit.decs.inteType" clearable
                                           @change="onSelectedInteTypeEdit(edit.decs.releaseType, edit.decs.inteType)"
                                           style="width: 100%">
                                    <el-option label="http" value="H"></el-option>
                                    <el-option label="kafka" value="K"></el-option>
                                    <el-option label="jar包引用" value="J"></el-option>
    ...
    export default {
        ...
        methods: {
            ...
            decsImportBefore(decsFile) {
                ...
                oldProdId = oldProdId.replace(/\./g, "\\.");
                //that.add.decsBackupDto = JSON.parse(decsFile.replaceAll(oldProdId,this.gConfig.prodId.value));
                that.add.decsBackupDto = JSON.parse(decsFile.replace(new RegExp(oldProdId, "g"), this.gConfig.prodId.value));
                //debugger
                try {
            ...
            decsFlowClickS(command, decs) {
                if (decs.releaseType === 'S') {
                    let mountUrl = "";
                    if(command == 'A'){
                        mountUrl = decs.inteConf.urlA;
                    }else{
                        mountUrl = decs.inteConf.urlB;
                    }
                    if(isEmpty(mountUrl)){
                        console.log("mountUrl值为空")
                    }else{
                        let decsFrontUrl = `${mountUrl}/ui/decsManage/decsInf?decsId=${decs.decsId}&tab=${tabType.decsFlowG6}&prodId=${this.gConfig.prodId.value}`;
                        const targetHostName = this.getTargetHostName();
                        console.log("获取postMessage目标地址：" + targetHostName);
                        let event = {flag: "tcssdkfrontapp", decsFrontUrl: decsFrontUrl};
            ...
            decsCodeClickS(command, decs) {
                if (decs.releaseType === 'S') {
                    ...
                    //let myWindow = window.open(`${decs.inteConf.mountUrl}/ui/decsManage/decsInf?decsId=${decs.decsId}&tab=decsFlowG6`,"_blank")
                    if (isEmpty(mountUrl)) {
                        console.log("mountUrl值为空")
                    } else {
                        let decsFrontUrl = `${mountUrl}/ui/decsManage/decsInf?decsId=${decs.decsId}&tab=${tabType.decsCode}&prodId=${this.gConfig.prodId.value}`;
                        const targetHostName = this.getTargetHostName()
                        console.log("获取postMessage目标地址：" + targetHostName);
                        let event = {flag: "tcssdkfrontapp", decsFrontUrl: decsFrontUrl};
                        window.parent.postMessage(event, targetHostName);
                        //let myWindow = window.open(`${decs.inteConf.mountUrl}/ui/decsManage/decsInf?decsId=${decs.decsId}&tab=DecsCode&prodId=${this.gConfig.prodId.value}`, "_blank")
                    }
                }
            },
            decsCodeClickN(decs) {
            ...
            decsHisClickS(command, decs) {
                if (decs.releaseType === 'S') {
                    ...
                    if (isEmpty(mountUrl)) {
                        ...
                        let decsFrontUrl = `${mountUrl}/ui/decsManage/decsInf?decsId=${decs.decsId}&tab=${tabType.decsHis}&prodId=${this.gConfig.prodId.value}`;
                        const targetHostName = this.getTargetHostName()
                        console.log("获取postMessage目标地址：" + targetHostName);
                        let event = {flag: "tcssdkfrontapp", decsFrontUrl: decsFrontUrl};
                        console.log("获取postMessage目标地址：" + targetHostName);
            ...
            decsCitationClickS(command, decs){
                if (decs.releaseType === 'S') {
                    let mountUrl = "";
                    if(command == 'A'){
                        mountUrl = decs.inteConf.urlA;
                    ...
                    if (isEmpty(mountUrl)) {
                        ...
                        let decsFrontUrl = `${mountUrl}/ui/decsManage/decsInf?decsId=${decs.decsId}&tab=${tabType.decsCitation}&prodId=${this.gConfig.prodId.value}`;
                        const targetHostName = this.getTargetHostName()
                        console.log("获取postMessage目标地址：" + targetHostName);
                        let event = {flag: "tcssdkfrontapp", decsFrontUrl: decsFrontUrl};
                        window.parent.postMessage(event, targetHostName);
                        //let myWindow = window.open(`${decs.inteConf.mountUrl}/ui/decsManage/decsInf?decsId=${decs.decsId}&tab=DecsCitation&prodId=${this.gConfig.prodId.value}`, "_blank")
                    }
                }

            },
            decsCitationClickN(decs) {
                if (decs.releaseType === 'N') {
                    this.$router.push({
                        path: this.childrenPath,
            ...
            decsVersionClickS(command, decs) {
                if (decs.releaseType === 'S') {
                    let mountUrl = "";
                    if(command == 'A'){
                        mountUrl = decs.inteConf.urlA;
                    ...
                    if (isEmpty(mountUrl)) {
                        ...
                        let decsFrontUrl = `${mountUrl}/ui/decsManage/decsInf?decsId=${decs.decsId}&tab=${tabType.decsVersion}&prodId=${this.gConfig.prodId.value}`;
                        const targetHostName = this.getTargetHostName()
                        console.log("获取postMessage目标地址：" + targetHostName);
                        let event = {flag: "tcssdkfrontapp", decsFrontUrl: decsFrontUrl};
                        window.parent.postMessage(event, targetHostName);
                        //let myWindow = window.open(`${decs.inteConf.mountUrl}/ui/decsManage/decsInf?decsId=${decs.decsId}&tab=DecsVersion&prodId=${this.gConfig.prodId.value}`, "_blank")
                    }
                } else {
                    this.$router.push({
                        path: this.childrenPath,
            ...
            decsPreHandleClickS(command, decs){
                if (decs.releaseType === 'S') {
                    let mountUrl = "";
                    if(command == 'A'){
                        mountUrl = decs.inteConf.urlA;
                    ...
                    if (isEmpty(mountUrl)) {
                        ...
                        let decsFrontUrl = `${decs.inteConf.mountUrl}/ui/decsManage/decsInf?decsId=${decs.decsId}&tab=${tabType.decsPreHandleJava}&prodId=${this.gConfig.prodId.value}`;
                        const targetHostName = this.getTargetHostName()
                        console.log("获取postMessage目标地址：" + targetHostName);
                        let event = {flag: "tcssdkfrontapp", decsFrontUrl: decsFrontUrl};
                        window.parent.postMessage(event, targetHostName);
