    ...
    export default {
        ...
        methods: {
            ...
            funcNameChange(value){
                if(this.func.funcDrl === undefined || this.func.funcDrl === '' || this.func.funcDrl.indexOf('function Object') === -1){
                    this.func.funcDrl = `function Object ${value}(){\n return null;\n}`
                }else {
                    let begin = this.func.funcDrl.indexOf('(');
                    let rightCode = this.func.funcDrl.substring(begin);
                    this.func.funcDrl = `function Object ${value}` + rightCode;
                }
            },
