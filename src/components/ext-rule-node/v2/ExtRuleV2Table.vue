    ...
    <div id="ExtRulesTable">
        ...
        <el-table
            ...
            <el-table-column type="expand">
                <template slot-scope="props">
                    <rule-show :p-rule="props.row"></rule-show>
                </template>
            </el-table-column>
            ...
            <el-table-column label="操作">
                <template slot-scope="props">
                    <el-button v-if="computeShowAble(props.row)" @click="versionSelBefore(props.row)" size="mini" type="success">选择版本</el-button>
                </template>
            </el-table-column>
        </el-table>
        ...
        <el-dialog
            ...
            <el-table
                ...
                <el-table-column label="操作">
                    <template slot-scope="props">
                        <el-button @click="versionSelAfter(props.row)" :disabled="props.row.disabled" size="mini" type="success">选择</el-button>
                    </template>
                </el-table-column>
            </el-table>
        </el-dialog>
...
<script>
    ...
    export default {
        ...
        computed: {
            computeShowAble() {
                return (row) => {
                    if (isNotEmpty(this.pDisableList)){
                        return !this.pDisableList.includes(row.ruleId)
                    }
                    return true;
                }
            },
        ...
        methods: {
            ...
            versionSelBefore(row) {
                ...
                // 判读当前规则是否能够选择 todo 11/16 不控制规则的选择，上线后没问题可以删除
