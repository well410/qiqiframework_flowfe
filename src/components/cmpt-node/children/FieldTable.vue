<template>
    ...
    <div>
        <pl-table
            ...
                :height-change="false"
                auto-resize>
            <pl-table-column prop="fieldName" label="字段路径"></pl-table-column>
            <pl-table-column prop="fieldType" label="字段类型"></pl-table-column>
            <pl-table-column prop="fieldDesc" label="字段描述"></pl-table-column>
            ...
            <el-form size="mini" label-width="80px">
                ...
                <el-form-item label="输入" v-if="editDialog.mapFields.fieldFrom === varFromEnums.edit.code">
                    <template class="flex-between-center">
                        <el-input :title="editDialog.mapFields.fieldResult" size="mini" style="width: 80%" v-model="editDialog.mapFields.fieldResult"></el-input>
                    </template>
                </el-form-item>
