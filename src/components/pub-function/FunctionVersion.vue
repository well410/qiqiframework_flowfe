...
<script>
    ...
    import PubDebugFunction from "../debug-comp/PubDebugFunction";
    ...
    export default {
        ...
        methods: {
            ...
            refreshPage() {
                let that = this;
                let params = {prodId: "pub", funcId: that.func.funcId, pageNum: that.pageNum, pageSize: that.pageSize, funcVersionFilter: that.filter};
                that.loading = true;
            ...
            queryFuncVersion(prodId, funcId) {
                ...
                that.loading = true;
                getFuncVersionRoll({prodId: "pub", funcId: that.func.funcId}).then(res => {
